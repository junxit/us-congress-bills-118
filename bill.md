...
This Act may be cited as the “Special Relationship Military Improvement Act of 2023”.
...
- **(2)** in subsection (j)(1), by striking subparagraph (C) and inserting after subparagraph (B) the following new subparagraphs:
  ...
  >   - **(vi)** defense articles for which Australian laws, regulations, or other commitments would prevent Australia from enforcing the control measures specified in such treaty.
