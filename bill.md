...
- **(b)** *Reporting*
  ...
  - **(2)** *Elements* The elements described in this paragraph are the following:
    ...
    - **(B)** Information relating to the cost of each project referred to in subparagraph (A) of such section.
    - **(C)** An identification of the account that funded each such project, if applicable.
