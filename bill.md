...
- **(a)** *In general* Chapter 4 of title 39, United States Code, is amended by adding at the end the following new section:
  ...
  > - **(c)** *Duration* For each covered postal retail facility, Postal Service shall provide the services required under subsection (a) using a vehicle or mobile facility of the Postal Service until the covered postal retail facility ceases to be a covered postal retail facility.
