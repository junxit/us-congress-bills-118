...
This Act may be cited as the “Keeping Gun Dealers Honest Act of 2023”.
...
- **(1)** in subsection (c)—
  ...
  - **(C)** by adding at the end the following:
    > - **(2)** The Attorney General may deny an application submitted under subsection (a) or (b) if the Attorney General determines that—
