...
## § 2. Organ procurement and transplantation network registration fees
...
- **(1)** in subsection (b)(2)—
  ...
  - **(G)** by adding at the end the following:
    ...
    > - **(R)** ensure compliance with the HIPAA privacy regulations (as defined in section 1180(b)(3) of the Social Security Act), as applicable, subject to regular audits by the Office for Civil Rights of the Department of Health and Human Services.
...
- **(2)** by adding at the end the following:
  ...
  >     - **(B)** be available, only to the extent and in the amounts provided in advance in appropriations Acts, to distribute such fees among the awardees described in subsection (b)(1)(A).
  ...
  >   - **(6)** *Sunset* The authority to collect registration fees under paragraph (1) shall expire on the date that is 5 years after the date of enactment of the OPTN Fee Collection Authority Act.
