...
- **(a)** *In general* Notwithstanding any other provision of law, in the case of an applicable employee, such employee shall not be authorized to telework during the period—
  ...
  - **(2)** ending on the date on which the Commissioner of Internal Revenue certifies that the processing backlog with respect to income tax returns for all taxable years has been eliminated.
