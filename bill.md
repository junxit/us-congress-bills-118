...
- **(c)** *Providing material support or resources to significant transnational criminal organizations* Section 2339B of title 18, United States Code, is amended—
  ...
  - **(2)** in subsection (a)(1), by striking the second sentence and inserting the following:
    > A person may not be prosecuted for violating this paragraph unless the person has knowledge that the organization referred to in the previous sentence—
