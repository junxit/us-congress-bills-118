...
This Act may be cited as the “AIxBio Defense Sandbox Act”.

## § 2. Plan for establishment of secure computing and data storage environment for testing of artificial intelligence trained on biological data
...
- **(b)** *Elements* The plan under subsection (a) shall provide as follows:
  ...
  - **(3)** *Responsible official* The Under Secretary of Defense for Research and Engineering shall be responsible for—
    ...
    - **(D)** arranging partnerships in accordance with paragraph (5).
  ...
  - **(5)** *Partnerships*
    ...
    - **(B)** *Streamlined processes* In carrying out subparagraph (A), the Under Secretary shall establish a streamlined processes to facilitate efficient collaboration between laboratories, organizations of the Department of Defense, and private entities for purposes of developing products for national security purposes and carrying out activities in support of projects under AIxBio sandbox, including testing and experimentation.
