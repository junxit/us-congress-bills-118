...
- **(2)** in subsection (a)—
  ...
  - **(B)** in paragraph (2)—
    ...
    - **(ii)** by inserting after subparagraph (A) the following new subparagraph (B):
      > - **(B)** County veterans service organizations.
...
- **(3)** in subsection (c), by striking paragraph (1) and inserting the following:
  > - **(1)** *Rural; highly rural* The terms rural and highly rural have the meanings given those terms under the Rural-Urban Commuting Areas (RUCA) coding system of the Department of Agriculture.

- **(4)** in subsection (d), by striking “$3,000,000 for each of fiscal years 2010 through 2022” and inserting “such sums as may be necessary”.
