...
- **(f)** *Prompt notification upon termination from participation* If the participation of an individual in an address confidentiality program is terminated, that individual shall promptly notify each executive agency or Federal court that accepted a designated address under subsection (b).
