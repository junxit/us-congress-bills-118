...
- **(1)** by striking “2025” and inserting “2028”;
- **(2)** in subparagraph (A), by striking “20” each place it appears and inserting “17”;
- **(3)** in subparagraph (B)—
  - **(A)** in clause (ii)—
    - **(i)** by inserting “or (ii)” before “that receives”; and
    - **(ii)** by inserting “or for behavioral and mental health treatment, respectively” before the period; and
  - **(B)** by redesignating clause (ii) as clause (iii) and inserting after clause (i) the following:
    ...
    >   - **(I)** to develop facilities to provide behavioral and mental health services such as—
    >     - **(aa)** prevention services;
    >     - **(bb)** treatment services;
    >     - **(cc)** recovery services; or
    >     - **(dd)** any combination of those services; and
    >   - **(II)** that employ staff that have appropriate expertise and training in how to identify and treat individuals with behavioral and mental health concerns.
