...
- **(a)** *Establishment*
  ...
  - **(3)** *Sunset*
    ...
    - **(C)** *Effect on certain permits* Any Good Samaritan permit granted by the deadline prescribed in subparagraph (A) or (B), as applicable, that is in effect on the date that is 7 years after the date of enactment of this Act shall remain in effect after that date in accordance with—
...
- **(e)** *Investigative sampling conversion*
  ...
  - **(2)** *Application*
    - **(A)** *Investigative sampling* An application for the conversion of an investigative sampling permit under paragraph (1) shall include any requirement described in subsection (c) that was not included in full in the application submitted under subsection (d)(3).
