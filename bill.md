...
- **(a)** *Definitions* In this section:
  ...
  - **(2)** *Zero-emission vehicle* The term zero-emission vehicle has the meaning given the term in section 220 of the Clean Air Act.
...
## § 3. National zero-emission vehicle standard
...
> - **(b)** *Compliance* For model year 2027 and each model year thereafter, each vehicle manufacturer shall meet the requirements of subsections (c) and (d) by submitting to the Administrator, not later than April 1 of the following calendar year, as applicable—
