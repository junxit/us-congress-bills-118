...
- **(2)** by adding at the end the following new subsection:
  ...
  >   - **(1)** *In general* The Secretary shall establish a pilot program to test the use of predictive risk-scoring algorithms to provide oversight of relevant transactions (as defined in paragraph (7)(B)).
  >   - **(2)** *Duration* The pilot program shall be conducted for a period of 2 years, beginning not later than January 1, 2025.
  >   - **(3)** *Scope*
  >     - **(A)** *In general* The Secretary shall limit the implementation of the pilot program to relevant transactions involving applicable items or services furnished to beneficiaries who have opted in to receive electronic Medicare Summary Notices (in this subsection referred to as applicable beneficiaries).
  >     - **(B)** *Voluntary participation* An applicable beneficiary may opt out of the pilot program at any time.
  ...
  >     - **(A)** adopt a predictive risk-scoring algorithm, modeled similar to leading payment card networks’ real-time consumer feedback mechanisms, that would learn from beneficiary data to score relevant transactions from 1 (least risky) to 99 (most risky);
  >     - **(B)** prior to implementation of any predictive risk-scoring algorithm adopted under subparagraph (A) under the pilot program—
  >       - **(i)** require sufficient testing, evaluation, and review of such algorithm, taking into consideration the Blueprint for an AI Bill of Rights issued by the White House Office of Science and Technology Policy in October, 2022;
  ...
  >         - **(II)** confirm the relevant transaction;
  ...
  >         - **(III)** include on such Medicare Summary Notices, as determined appropriate by the Secretary, information explaining how the beneficiary may report suspected fraud to relevant law enforcement agencies.
  ...
  >     - **(B)** *Relevant transaction* The term relevant transaction means a claim for payment for an applicable item or service furnished to an applicable beneficiary, as determined by the Secretary.
