...
- **(c)** *Qualifying executive order* The term qualifying executive order means any executive order (including an executive order that revokes or nullifies a previous executive order) issued on or after the date of the enactment of this Act, relating to the energy policy of the United States.
