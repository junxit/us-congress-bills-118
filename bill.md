...
- **(4)** by inserting after paragraph (3) the following:
  ...
  >       - **(II)** does not include questions to estimate eligibility for the benefits described in subclause (I), the results screen—
  >         - **(aa)** indicates that certain students (or prospective students) may qualify for such benefits;
...
>     - **(i)** enables users to answer 1 set of questions and receive net prices for any institution that is required to have a net price calculator under this subsection;
