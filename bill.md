...
- **(a)** *In general* Title II of the Social Security Act is amended by adding after section 234 (42 U.S.C. 434) the following new section:
  ...
  > - **(b)** *Deemed Wages*
  >   - **(1)** *In general* For purposes of determining entitlement to and the amount of any monthly benefit for any month, or entitlement to and the amount of any lump-sum death payment in the case of a death, payable under this title on the basis of the wages and self-employment income of any qualifying individual, such individual shall be deemed to have been paid during each qualifying month at an amount per month equal to 1/12th of the national average wage index (as defined in section 209(k)(1)) for the second calendar year preceding the calendar year in which such month occurs.
...
- **(c)** *Effective date* The amendments made by this section shall take effect on the date which is 24 months after the date of enactment of this Act.
