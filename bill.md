...
- **(a)** *In general* Section 404(e) of the Social Security Act (42 U.S.C. 604(e)) is amended to read as follows:
  ...
  >     - **(C)** *Notice of intent to reserve funds* A State that intends to reserve funds under subparagraph (A) shall notify the Secretary of the intention not later than the end of the period in which the funds are available for obligation without regard to subparagraph (A) of this paragraph.
