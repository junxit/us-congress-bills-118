...
- **(15)** *Use case* The term use case means the ways and context in which artificial intelligence is operated to perform a specific function.
...
- **(b)** *Annual briefing* Not later than 180 days after the date of enactment of this Act, and annually thereafter, the Director shall brief the appropriate Congressional committees on implementation of this Act and related considerations.

## § 4. Procurement of artificial intelligence
...
- **(b)** *Requirements for high risk use cases*
  ...
  - **(2)** *Rules of construction* This Act shall supersede any requirements that conflict with this Act under the guidance required to be produced by the Director pursuant to section 7224(d) of the Advancing American AI Act (40 U.S.C. 11301 note).

## § 5. Interagency governance of artificial intelligence
...
- **(g)** *Incident reporting*
  ...
  - **(3)** *Notice to deployer*
    ...
    - **(B)** *Waiver*
      ...
      - **(iii)** *Notice* The head of an agency shall forward advance notice of any waiver under this subparagraph to the Director, or the designee of the Director.

## § 6. Agency governance of artificial intelligence
...
- **(d)** *Effective date* Beginning on the date that is 120 days after the date of enactment of this Act, an agency shall not develop or procure or obtain artificial intelligence prior to completing the requirements under paragraphs (2) and (3) of subsection (a).

## § 7. Agency risk classification of artificial intelligence use cases for procurement and use
...
## § 8. Agency requirements for use of artificial intelligence
...
- **(d)** *Pre-Deployment requirements for high risk use cases* Beginning on the date that is 1 year after the date of enactment of this Act, the head of an agency shall not deploy or use artificial intelligence for a high risk use case prior to—
  ...
  - **(4)** establishing appropriate agency training programs, including documentation of completion of training prior to use of artificial intelligence, that educate agency personnel involved with the application of artificial intelligence in high risk use cases on the capacities and limitations of artificial intelligence, including training on—
    ...
    - **(G)** procedures for reporting incidents involving misuse, faulty results, safety and security issues, and other problems with use of artificial intelligence that does not function as intended.
- **(e)** *Ongoing monitoring of artificial intelligence in high risk use cases* The Chief Artificial Intelligence Officer of each agency shall—
...
- **(j)** *Compliance deadline* Not later than 270 days after the date of enactment of this Act, the requirements of subsections (a) through (i) of this section shall apply with respect to artificial intelligence that is already in use on the date of enactment of this Act.

## § 9. Prohibition on select artificial intelligence use cases
...
## § 10. Agency procurement innovation labs
...
## § 11. Multi-phase commercial technology test program
...
- **(g)** *Sunset* The authority for a test program under this section shall terminate on the date that is 5 years after the date the Federal Acquisition Regulation is revised pursuant to subsection (f)(1) to implement the program.

## § 12. Research and development project pilot program
...
- **(j)** *Sunset* The authority for a pilot program under this section shall terminate on the date that is 5 years from the date the Federal Acquisition Regulation is revised pursuant to subsection (h)(1) to implement the program.

## § 13. Development of tools and guidance for testing and evaluating artificial intelligence
...
- **(d)** *Sunset* The requirements under this section shall terminate on the date that is 10 years after the date of enactment of this Act.

## § 14. Updates to artificial intelligence use case inventories
