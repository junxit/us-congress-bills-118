...
This Act may be cited as the “Eviction Right to Counsel Act of 2024”.
...
- **(b)** *Establishment of fund*
  ...
  - **(2)** *Deposits to the fund* There are authorized to be appropriated to the Fund $100,000,000 for each of fiscal years 2025 through 2029 for the cost of making grants under subsection (c).
- **(c)** *Grants*
  - **(1)** *In general* The Secretary shall establish a program to provide grants to eligible entities that enact right to counsel legislation.
  - **(2)** *Application*
    ...
    - **(B)** *Requirement* An application submitted under subparagraph (A) shall include a certification that the eligible entity has enacted right to counsel legislation.
