...
- **(a)** *Evidence*
  ...
  - **(2)** *Forms of evidence* In determining whether it is more likely than not that an individual or household has constructive ownership under paragraph (1), the Administrator shall consider all evidence provided by an individual or household, including the following:
    ...
    - **(G)** Any other documentation, certification, identification, or proof of occupancy or ownership not included on this list that can reasonably link the individual requesting assistance to the applicable property, as determined by the President.
