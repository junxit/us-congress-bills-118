...
- **(5)** *Token* The term token means a transferable, digital representation of information recorded on blockchain technology or other distributed ledger technology.
...
- **(e)** *Rules of construction* Nothing in this section may be construed to—
  ...
  - **(4)** require the adoption of the best practices described in subsection (c).
...
- **(g)** *Termination of Program* The Blockchain Deployment Program established pursuant to subsection (b)(3) shall terminate on the date that is 7 years after the date of the enactment of this Act.
