...
- **(c)** *Smithsonian Institution*
  - **(1)** *In general* Following the award of the gold medal under subsection (a), the gold medal shall be given to the Smithsonian Institution, where the medal shall be available for display as appropriate and made available for research.
  - **(2)** *Sense of Congress* It is the sense of Congress that the Smithsonian Institution should make the gold medal received under paragraph (1) available for display elsewhere, particularly at appropriate locations associated with the United States Colored Troops.
