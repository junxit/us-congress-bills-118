...
- **(a)** *Establishment* Section 527 of title 38, United States Code, is amended—
  ...
  - **(2)** by redesignating subsections (b) and (c) as paragraphs (2) and (3), respectively; and
...
- **(c)** *Applicability* The standard practices prescribed in such regulations shall apply to a grant or pilot program without regard to when such program was established.
