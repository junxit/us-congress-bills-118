...
- **(2)** *Requirement for major rule*
  ...
  - **(B)** *Certified cost* For any rule issued in accordance with subparagraph (A), the Administrator of the Office of Information and Regulatory Affairs of the Office of Management and Budget must have certified that the cost of the new major rule is equal to or less than the cost of the rules repealed.
