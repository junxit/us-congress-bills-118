...
- **(a)** *Definitions*
  ...
  - **(5)** *Washington, DC metropolitan area* The term Washington, DC metropolitan area means—
...
- **(b)** *Establishment* There is established a Commission to study the relocation of covered agencies based in the Washington, DC metropolitan area to other areas throughout the United States.
...
- **(d)** *Report*
  ...
  - **(2)** *Factors* In developing the report required under paragraph (1), the Commission shall recommend the transfer of covered agencies with consideration of—
    ...
    - **(D)** whether, at any time during the 5-year period preceding the date of enactment of this Act, a sizeable portion of the workforce of the covered agency has participated in telework.
