...
- **(a)** *In general* Section 209 of the Clean Air Act (42 U.S.C. 7543) is amended—
  ...
  - **(3)** in subsection (e)—
    ...
    - **(C)** by striking the subsection designation and heading and all that follows through “No State” in paragraph (1) and inserting the following:
      > - **(e)** *Prohibition on certain State standards for nonroad engines or vehicles* No State

    - **(D)** by redesignating subparagraphs (A) and (B) as paragraphs (1) and (2), respectively, and indenting appropriately; and
