...
- **(h)** *Written recommendations*
  ...
  - **(4)** *Public outreach* In addition to soliciting and collecting written recommendations under paragraph (1), the Task Force shall conduct public outreach and convene focus groups in geographically diverse areas throughout the United States to solicit feedback and public comments regarding regulations described in subsection (e).
...
- **(j)** *Special message to Congress*
  ...
  - **(5)** *Floor consideration in the Senate*
    ...
    - **(B)** *Floor consideration*
      ...
      - **(ii)** *Amendments* In the Senate, no amendment to a covered resolution shall be in order, except an amendment that strikes from or adds to the list required under paragraph (1)(A)(i) a regulation recommended for repeal by the Task Force.
