...
- **(a)** *In general* Section 501(p) of the Internal Revenue Code of 1986 is amended by adding at the end the following new paragraph:
  ...
  >     - **(ii)** *Opportunity to cure* In the case of any notice provided to an organization under clause (i), the Secretary shall, at the close of the 90-day period beginning on the date that such notice was sent, designate such organization as a terrorist organization under subparagraph (B) if (and only if) such organization has not (during such period)—
