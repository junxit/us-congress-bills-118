...
- **(a)** *In general* Section 149(d) of the Internal Revenue Code of 1986 is amended—
  ...
  - **(3)** by inserting after paragraph (1) the following new paragraphs:
    ...
    >     - **(i)** *Issuer must redeem only if debt service savings* Clauses (ii) and (iii) of subparagraph (A) shall apply only if the issuer may realize present value debt service savings (determined without regard to administrative expenses) in connection with the issue of which the refunding bond is a part.
