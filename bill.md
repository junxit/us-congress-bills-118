...
- **(a)** *In general* Subtitle H of title VIII of the Homeland Security Act of 2002 (6 U.S.C. 451 et seq.) is amended by adding at the end the following new section:
  ...
  >   - **(3)** maintain a risk-based methodology to assess ratings requests, including requests submitted pursuant to paragraph (2), that considers the anticipated attendance by United States officials or foreign dignitaries, the size and venue of the special event, credible threats of terrorism or other security threats, and other homeland security information, as appropriate; and
  ...
  >   - **(1)** The total number of special events submitted to the program authorized under subsection (a) in the prior year, including the number of special events at each rating level.
