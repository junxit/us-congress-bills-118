...
This Act may be cited as the “Coal Cleanup Taxpayer Protection Act of 2024”.
...
- **(1)** by striking subsection (c) and inserting the following:
  ...
  >     - **(A)** A history of bond forfeitures and reclamation costs in such State in the 7-year period ending on the date on which the report is submitted, including—
  ...
  >     - **(B)** A 5-year forecast proving the proposed bond pool will be financially sound based on—
  ...
  >       - **(iii)** market projections for the 5-year period beginning on the date of the submission of such report;
