...
- **(e)** *Termination* The education program established under subsection (a) shall terminate on December 31, 2030.
- **(f)** *Briefing* Not later than 6 months after the Administrator establishes the education program under subsection (a), and periodically thereafter until the termination date described in subsection (e), the Administrator shall provide to the Committee on Transportation and Infrastructure of the House and the Committee of Commerce, Science, and Transportation of the Senate a briefing containing the status of, and any findings with respect to, such program, including the following elements:
