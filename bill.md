...
- **(a)** *Aliens not subject to direct numerical limitations* Section 201(b)(1) of the Immigration and Nationality Act (8 U.S.C. 1151(b)(1)) is amended by adding at the end the following:
  ...
  >     - **(II)** have an offer of employment from, or are employed by, a United States employer to perform work that is directly related to such degree at a rate of pay that is higher than the median wage level for the occupational classification in the area of employment, as determined by the Secretary of Labor;
