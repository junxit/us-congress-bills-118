...
- **(2)** in subsection (o)(1)—
  ...
  - **(B)** in subparagraph (A)—
    ...
    - **(iii)** by adding at the end the following:
      > - **(ii)** of which not more than 50 percent of the total gross sales are from hot foods or hot food products ready for immediate consumption; or

- **(3)** in subsection (q)(2)—
  - **(A)** by striking “include accessory” and inserting the following:
    > include—
    > - **(A)** accessory
