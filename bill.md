...
## § 2. Entrance counseling financial aid disclosures
...
- **(2)** in paragraph (1)(A)—
  - **(A)** in the matter preceding clause (i), by striking “a disbursement to a first-time borrower” and inserting “the first disbursement to a borrower in each award year”; and
...
- **(3)** in paragraph (2)—
  ...
  - **(C)** by striking subparagraph (G) and inserting the following:
    ...
    >   - **(i)**
    >     - **(I)** the median levels of indebtedness, as appropriate, of—
    ...
    >   - **(ii)** the median annual earnings for individuals who attended the institution, as described in subparagraph (N).
  ...
  - **(D)** by adding at the end the following:
    ...
    >   - **(v)** any capitalization of interest on the loan.
...
## § 3. Annual requirement to manually enter loan amount
