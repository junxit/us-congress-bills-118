...
## § 2. Increased in employer-provided child care credit amount
...
- **(b)** *Applicable percentage* Section 45F(a) of such Code, as amended by subsection (a), is amended—
  ...
  - **(3)** by adding at the end the following new paragraph:
    ...
    >     - **(iii)** in the case of any qualified child care expenditures paid in connection with a qualified child care facility located in a qualified census tract, 60 percent.
...
## § 3. Rules of application for multi-employer facilities
