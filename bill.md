...
- **(a)** *In general* The Secretary of Health and Human Services may not—
  - **(1)** directly or indirectly conduct research that involves testing on vertebrate animals in any facility, or through any entity, owned or controlled, directly or indirectly, by—
  ...
  - **(2)** support, through grants, subgrants, contracts, cooperative agreements, or other funding vehicles, research that involves testing on vertebrate animals conducted by any entity based in a foreign country referred to in paragraph (1).
...
- **(c)** *Report on addition to list of foreign countries*
  ...
  - **(2)** *Timing* A report shall be submitted under paragraph (1) not later than 60 days after the date of an instance described in such paragraph.
