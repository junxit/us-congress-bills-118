...
>         - **(I)** has been voluntarily made available to the general public by a covered person on a social media plat form or similar service;
...
>     - **(L)** the term “automated license plate recognition system” or “ALPR system” means a system of one or more mobile or fixed high-speed cameras combined with computer algorithms to convert images of license plates into computer-readable data.
>   - **(2)** *Limitation*
