...
- **(1)** to authorize—
  - **(A)** manufacturers and secondary engine manufacturers to request a national security exemption under such section 1068.225(d) for engines or equipment intended to be used by Federal, State, or local agencies for providing law enforcement, disaster relief, search and rescue, fire response, or emergency medical services; and
