...
- **(a)** *In general* Section 223 of the Communications Act of 1934 (47 U.S.C. 223) is amended—
  ...
  - **(2)** by inserting after subsection (g) the following:
    ...
    >         - **(V)** to seek support or help with respect to the receipt of an unsolicited intimate visual depiction;
    >       - **(iii)** a disclosure reasonably intended to assist the identifiable individual; or
    >       - **(iv)** a person who possesses or publishes a digital forgery of himself or herself engaged in nudity or sexually explicit conduct (as that term is defined in section 2256(2)(A) of title 18, United States Code).
    >   - **(4)** *Penalties*
