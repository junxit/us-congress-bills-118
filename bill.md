...
>     - **(i)** *In general* At least once each fiscal year, a State transportation department or local transportation agency utilizing the exception authority provided in subparagraph (B) shall submit to the Secretary a report containing—
...
>     - **(ii)** *Public employee* The term “public employee” means an employee of the Federal Government, a State government, or a local government.
