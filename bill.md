...
This Act may be cited as the “Northern Mariana Islands Medicaid Equivalence Act”.
...
- **(1)** in clause (i), by striking “clause (ii)” and inserting “clauses (ii) through (iv)”;
- **(2)** in clause (ii), by striking “and” at the end; and
- **(3)** by adding at the end the following new clause:
  > - **(iv)** for fiscal year 2024, the amount determined under subparagraph (E) with respect to American Samoa for such fiscal year; and
