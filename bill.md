...
- **(c)** *Treatment of deposit insurance applications pending on September 23, 2021*
  ...
  - **(2)** *Deadline for approving application* If the Corporation does not approve an application described in paragraph (1) before September 30, 2024, that application shall be deemed to have been denied.
