...
- **(c)** *Extension of time for payment of tax*
  - **(1)** *In general* Section 6161(a) of the Internal Revenue Code of 1986 is amended by adding at the end the following new paragraph:
    > - **(3)** *Wealth tax*
    >   - **(A)** *In general* In the case of taxpayer described in subparagraph (B), the Secretary may extend the time for payment of the tax imposed under chapter 18 for a reasonable period not to exceed 5 years from the date fixed for the payment thereof.
    >   - **(B)** *Taxpayers described* A taxpayer is described in this subparagraph if such the Secretary determines—
    >     - **(i)** the taxpayer has severe liquidity constraints, or
...
- **(a)** *In general* Subchapter A of chapter 80 of the Internal Revenue Code of 1986 is amended by adding at the end the following new section:
  ...
  >
  > There are authorized to be appropriated to the Secretary for the period of fiscal years 2024 through 2034—
  >
