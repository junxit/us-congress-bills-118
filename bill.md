...
## § 2. Resources for small businesses to utilize artificial intelligence
...
- **(2)** by inserting after subsection (g) the following new subsection:
  ...
  >   - **(3)** *Review and update of resources* Not later than two years after the date of enactment of this subsection and not less frequently than once every two years thereafter, the Director shall carry out the following:
  ...
  >   - **(6)** *Report*
  >     - **(A)** *In general* Not later than four years after the date of the enactment of this subsection, the Director shall submit to the Committee on Science, Space, and Technology of the House of Representatives and the Committee on Commerce, Science, and Transportation of the Senate a report, including updates made, on the development, identification, dissemination, and use of the resources described in paragraph (1).
  >     - **(B)** *Contents* The report under subparagraph (A) shall include the following:
  >       - **(i)** A list of the resources described in paragraph (1), including updates made.
