...
This Act may be cited as the “Innovative Materials for America's Growth and Infrastructure Newly Expanded Act of 2023” or the “IMAGINE Act of 2023”.
...
>   - **(v)** *Authorization of appropriations* There is authorized to be appropriated to carry out this subparagraph $8,000,000 for each of fiscal years 2024 through 2028.
...
- **(d)** *Eligible projects* To be eligible to receive a grant under this section, a coastal or rural infrastructure bridge project or a value engineering project shall—
  - **(1)** be a project to add multimodal transportation components, such as bicycle and pedestrian paths, to an existing single span suspension bridge that—
    - **(A)** has a main span length of greater than 1500 feet; and
    - **(B)** is more than 50 years old;
  - **(2)** be carried out in a manner so as to reduce traffic impact; and
...
- **(e)** *Preferences* In providing grants under this section, the Administrator shall give preference to proposed projects that—
  ...
  - **(3)** graft multimodal transportation components to the existing bridge in such a way as to maintain secure spatial separation for bicyclists and pedestrians from vehicular traffic; and
  - **(4)** retrofit a bridge.
...
- **(g)** *Authorization of appropriations* There is authorized to be appropriated to the Administrator to carry out this section $65,000,000 for each of fiscal years 2024 through 2028.
...
- **(a)** *In general* Section 120(c)(3)(B) of title 23, United States Code, is amended—
  ...
  - **(4)** by inserting after clause (vi) the following:
    > - **(vii)** innovative pavement materials that demonstrate reductions in greenhouse gas emissions through sequestration or innovative manufacturing processes; or
