...
## § 3. Grants to eligible entities for enhanced protection of senior investors and senior policyholders
...
- **(a)** *In general* Section 989A of the Investor Protection and Securities Reform Act of 2010 (12 U.S.C. 5537) is amended to read as follows:
  ...
  > - **(b)** *Grant program*
  >   - **(1)** *In general* The Commission shall carry out a program under which the Commission shall make grants, on a competitive basis, to eligible entities, which—
  ...
  >     - **(A)** *Public information* In carrying out paragraph (1), the Commission shall make public relevant actions of the Commission relating to carrying out that paragraph.
  >     - **(B)** *Sense of Congress* It is the sense of Congress that, in carrying out paragraph (1), the Commission should use the authority of the Commission under section 4A of the Securities Exchange Act of 1934 (15 U.S.C. 78d–1) to delegate the functions of the Commission under paragraph (1) to an employee or employee board that has experience working with or for State regulators on issues relating to the protection of senior investors, including such investors who are vulnerable.
  > - **(c)** *Applications* An eligible entity desiring a grant under this section shall submit an application to the Commission, in such form and in such a manner as the Commission may determine, that includes—
  ...
  >   - **(3)** *Audits* The Commission shall annually conduct an audit of the program under this section to ensure that eligible entities to which grants are made under that program are, for the year covered by the audit, using grant funds for the intended purposes of those funds.
  ...
  > - **(f)** *Subgrants* An eligible entity that receives a grant under this section may, in consultation with the Commission, make a subgrant, as the eligible entity determines is necessary or appropriate—
...
- **(b)** *Conforming amendment* The table of contents in section 1(b) of the Dodd-Frank Wall Street Reform and Consumer Protection Act (Public Law 111–203) is amended by striking the item relating to section 989A and inserting the following:
