...
- **(a)** *Findings* Congress makes the following findings:
  ...
  - **(6)** Assault and intimidation against hospital employees substantially affects interstate commerce in many ways, including the following:
    - **(A)** Health care services are a significant part of the national economy. In 2021, expenditures on health care services accounted for 18.3 percent of the country’s gross domestic product (or $4,300,000,000,000). Within health care, hospitals and health systems are economic pillars that create jobs and support economic growth across State lines. In 2021, hospitals directly employed 6,350,000 individuals. More broadly, hospitals supported 17,815,000 jobs throughout the entire interstate economy—1 out of 8 jobs in the United States—and supported nearly $4,000,000,000 in overall economic activity.
