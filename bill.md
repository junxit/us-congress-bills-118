...
- **(b)** *General business credit* Section 38 of such Code is amended—
  - **(1)** in subsection (b), by striking paragraphs (8), (21), (29), (36), (37), (38), and (39) and redesignating paragraphs (9)–(20), (22)–(28), (30)–(35), and (40)–(41) as paragraphs (8)–(19), (20)–(26), (27)–(32), and (33)–(34), respectively, and
...
- **(c)** *Conforming amendments*
  ...
  - **(6)** Section 45Z of such Code is amended—
    ...
    - **(B)** by amending subsection (d)(4) to read as follows:
      > - **(4)** *Qualified facility* The term “qualified facility” means a facility used for the production of transportation fuels.
  ...
  - **(17)** Section 6417 of such Code is amended—
    - **(A)** in subsection (b), by striking paragraphs (2), (3), (4), (5), (7), (8), (10), (11), and (12) and by redesignating paragraphs (6) and (9) as paragraphs (2) and (3), respectively, and
    - **(B)** in subsection (d)—
      - **(i)** by amending paragraph (1) to read as follows:
        ...
        >   - **(F)** any corporation operating on a cooperative basis which is engaged in furnishing electric energy to persons in rural areas.
  ...
  - **(18)** Section 6418(f)(1) of such Code is amended—
    - **(A)** in subparagraph (A), by striking clauses (ii)–(vii) and (ix)–(xi) and by redesignating clause (viii) as clause (ii),
    - **(B)** by striking subparagraph (B), and
    - **(C)** by redesignating subparagraph (C) as subparagraph (B).
- **(d)** *Effective date* The amendments made by this subsection shall apply to taxable years beginning after December 31, 2022.
