...
This Act may be cited as the “Vision Lab Choice Act of 2024”.
...
- **(a)** *In general* Title XXVII of the Public Health Service Act is amended by inserting after section 2719A (42 U.S.C. 300gg–19a) the following new section:
  > ## § 2719B. Improving coverage under vision plans
  >
  ...
  >   - **(1)** *Duration of limited scope vision plans* In the case of an agreement between a doctor of optometry or a facility employing a doctor of optometry, with respect to a plan or coverage that offers limited scope vision benefits—
  >     - **(A)** the term of the initial agreement shall be not longer than 2 years;
  >     - **(B)** the agreement may be extended with the prior acceptance by the doctor of optometry or facility employing a doctor of optometry for each such term extension, and any such extension may be for a term not longer than 2 years; and
  >     - **(C)** the agreement may be extended for unlimited terms, subject to subparagraph (B).
  >   - **(2)** *No restrictions on choice of laboratories and sources and suppliers* A group health plan or health insurance issuer offering such coverage may not, directly or indirectly, restrict or limit a doctor of optometry or facility employing a doctor of optometry with respect to choice of laboratories, or choice of source or supplier of services or materials provided by the doctor or facility to an individual who is enrolled under the plan or coverage.
  ...
  >   - **(1)** the term doctor of optometry means a doctor of optometry who is legally authorized to practice optometry by the State in which the doctor so practices; and
  >   - **(2)** the term facility that employs a doctor of optometry means an entity that retains the services of a doctor of optometry for purposes that include the delivery of limited scope vision benefits services.

- **(b)** *Conforming amendment* Section 2722(c)(1) of the Public Health Service Act (42 U.S.C. 300gg–21(c)(1)) is amended by inserting “(other than the requirements under section 2719B)”.
