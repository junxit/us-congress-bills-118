...
> To require the Board of Governors of the Federal Reserve System to carry out a review of discount window operations, and for other purposes.

## § 1. Short title

This Act may be cited as the “Bringing the Discount Window into the 21st Century Act”.

## § 2. Review of discount window operations
...
- **(2)** by adding at the end the following:
  ...
  >       - **(I)** the findings of the review required by subparagraph (A);
