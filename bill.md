...
- **(b)** *Rules* The Commission shall, in accordance with section 8, establish rules for reports under subsection (a). Such rules shall require that a report include the following information:
  ...
  - **(2)** *Automated content detection and decision-making processes* If the covered platform elects to use algorithmic processes to detect content for additional manual review or automated decision-making for content moderation, information on such processes, including—
...
- **(b)** *Duties*
  ...
  - **(2)** *Covered technology* For purposes of paragraph (1), the term covered technology means technology used to—
    ...
    - **(B)** process or generate language stored in a machine-readable format, such as natural language processing, including large language models;
    - **(C)** detect and process images and videos into a machine-readable format, or process images or videos stored in a machine-readable format; and
    - **(D)** make automated decisions related to content removal, ranking, or presentation to a user of an online platform.
...
## § 10. International online communication research activities pilot program
