...
- **(3)** *Fund* The term Fund means the Renewable Energy Resource Conservation Fund established by section 5(c)(1).
- **(4)** *Renewable energy project* The term renewable energy project means a project carried out on covered land that uses wind, solar, or geothermal energy to generate energy.
...
- **(a)** *Disposition of revenues*
  - **(1)** *Availability* Except as provided in paragraph (2), beginning on January 1, 2025, of amounts collected from a wind or solar project as bonus bids, rentals, fees, or other payments under a right-of-way, permit, lease, or other authorization the following shall be made available, without further appropriation or fiscal year limitation, as follows:
