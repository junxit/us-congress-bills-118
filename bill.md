...
- **(1)** in subsection (b)(7)(A)(iii)—
  ...
  - **(B)** by adding at the end the following:
    > - **(VI)** sequential, standards-based arts education taught by certified arts educators (as defined by the State) and community arts providers to meet the challenging State academic standards; and
