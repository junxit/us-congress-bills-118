...
- **(a)** *Definitions* In this section:
  - **(1)** *Covered farmland* The term covered farmland has the meaning given in the term in section 1540(c)(1) of the Farmland Protection Policy Act (7 U.S.C. 4201(c)(1)).
  - **(2)** *Conversion* The term conversion means, with respect to covered farmland, any activity that results in the covered farmland failing to meet the requirements of a State (as defined in section 343 of the Consolidated Farm and Rural Development Act (7 U.S.C. 1991)) for agricultural production, activity, or use.
...
- **(c)** *Exception* Subsection (b) shall not apply to a project if the project—
  - **(1)** results in the conversion of less than the greater of—
    - **(A)** a de minimis amount of covered farmland for solar energy production relative to the total project area necessary for the success of the project, as determined by the Secretary, not to exceed 5 acres; or
    - **(B)** 1 acre of covered farmland; and
  - **(2)** has received a resolution of approval or support, or other similar instrument from each county and municipality in which the project is sited.
- **(d)** *Covered farmland protection*
  - **(1)** *Mitigation and remediation plan required* A person who has applied to the Secretary for financial assistance for a project that would result in the conversion of covered farmland for solar energy production and to which subsection (b) does not apply shall—
    - **(A)** develop a mitigation and remediation plan for the project to—
    ...
    - **(B)** ensure that sufficient funds, as determined by the Secretary, are provided for the decommissioning of the solar energy production system and the remediation and restoration of covered farmland to carry out the mitigation and remediation plan described in subparagraph (A).
  ...
  - **(3)** *Plan implementation* A person referred to in paragraph (1) shall carry out—
