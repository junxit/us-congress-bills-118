...
## § 2. Application of NEPA and NHPA to floodplains
...
- **(c)** *Definitions* In this section:
  ...
  - **(3)** *Covered project* The term covered project means a project—
    - **(A)** for the deployment or modification of a communications facility that is to be carried out entirely within a floodplain (as defined in section 9.4 of title 44, Code of Federal Regulations, as in effect on the date of the enactment of this Act); and
