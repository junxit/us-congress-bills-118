...
- **(a)** *Definitions* In this section:
  ...
  - **(3)** *Eligible recipient* The term eligible recipient means—
    ...
    - **(G)** an Indian Tribe or tribally designated housing entity; or
    - **(H)** any other entity approved by the Secretary working with an eligible manufactured home community.
