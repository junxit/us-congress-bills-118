...
## § 2. Forest Service Legacy Road and Trail Remediation Program transparency
...
- **(1)** in subsection (c)(2)—
  - **(A)** by striking subparagraph (B) and inserting the following:
    ...
    >   - **(iii)** considering public comments in selecting projects for funding under the Program;
  ...
  - **(B)** in subparagraph (D)—
    ...
    - **(ii)** by striking clause (ii) and inserting the following:
      ...
      >   - **(IV)** the proposed outcome of each project funded under the Program for the applicable fiscal year.
