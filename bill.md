...
- **(a)** *In general* Part III of subchapter B of chapter 1 of the Internal Revenue Code of 1986 is amended by inserting before section 140 the following new section:
  ...
  >
  > - **(a)** *In general* Gross income shall not include any amount received as a judgment, award, or settlement (including back pay, front pay, punitive damages, or any payments made in connection with a release of claims or to resolve, settle, or litigate claims), whether by lump sum or periodic payments, from—
