...
- **(2)** in paragraph (5) by inserting after subparagraph (C) the following:
  > - **(D)** assessing current and future electrical power demand.

## § 3. Increasing the energy efficiency of airports and meeting current and future electrical power demands
...
- **(a)** *In general* Section 47140 of title 49, United States Code, is amended to read as follows:
  ...
  >       - **(i)** current and future electrical power requirements, including—
  >         - **(I)** heating and cooling;
  >         - **(II)** on-road airport vehicles, including ground support equipment;
  >         - **(III)** gate electrification; and
  >         - **(IV)** electric aircraft charging; and
  >       - **(ii)** existing electrical infrastructure condition, location and capacity, including base load and backup power, to meet the current and future electrical power demand as identified in this subparagraph; and
...
## § 4. Electric aircraft infrastructure pilot program
...
- **(c)** *Sunset* The pilot program established under subsection (a) shall sunset 5 years after the date of enactment of this Act.
