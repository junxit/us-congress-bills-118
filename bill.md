...
- **(2)** by inserting after subsection (c) the following:
  ...
  > - **(e)** *Additional authority* To carry out subsection (d), the Secretary of Transportation and the Secretary of Agriculture may promulgate such rules and regulations, and issue such orders or guidance, as are necessary.
...
- **(2)** by adding at the end the following:
  > - **(b)** *Prohibition*
  >   - **(1)** *In general* No person shall move in interstate commerce livestock that are unfit to travel.
  >   - **(2)** *Unfit defined*
  ...
  >     - **(B)** *Inclusions* Such term includes livestock that—
  ...
  >   - **(3)** *Exception* Nothing in this subsection shall be construed to limit the movement in interstate commerce of any livestock for purposes of providing veterinary care to such livestock.
