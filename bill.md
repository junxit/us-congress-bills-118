...
- **(c)** *Considerations* In awarding grants to eligible entities under subsection (a), the Secretary shall consider the extent to which a project would—
  ...
  - **(4)** support park and recreation programming provided by cities, including cooperative agreements with community-based eligible nonprofit organizations;
  - **(5)** develop Native American event sites and cultural gathering spaces; and
  - **(6)** provide benefits such as community resilience, reduction of urban heat islands, enhanced water or air quality, or habitat for fish or wildlife.
- **(d)** *Eligible uses*
...
## § 4. Review and evaluation requirements
