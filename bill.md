...
>   - **(1)** *State share* For fiscal year 2024 and each fiscal year thereafter, the amount for each State of combined apportionments for sections 119, 133, 148, 149, 167, 175, 176(c), and to carry out section 134 shall be determined as follows:
...
>   - **(2)** *State apportionment* On October 1 of each fiscal year described in paragraph (1), the Secretary shall apportion the sum authorized to be appropriated for expenditure on the programs under sections 119, 133, 148, 149, 167, 175, 176(c), and to carry out section 134 in accordance with paragraph (1).
