...
## § 2. Digital advertising platforms public service advertising reporting
...
- **(a)** *In general* A covered digital advertising platform shall submit to the Commission an annual report that includes the following:
  ...
  - **(3)** The number of such public service advertisements that focus on local or regional mental, behavioral, and physical health resources.
