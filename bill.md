...
- **(a)** *HSAs* Section 223(d)(2) of the Internal Revenue Code of 1986 is amended—
  ...
  - **(2)** by adding at the end the following new subparagraph:
    > - **(E)** *Wearable device* For purposes of this paragraph, the term “wearable device” means a device or software that—
    >   - **(i)** is worn on the body or is used primarily in connection with a device that is worn on the body, and
    >   - **(ii)** collects and analyzes physiological data for the diagnosis, cure, mitigation, treatment, or prevention of disease.
...
- **(d)** *Effective dates*
  - **(1)** *Distributions from savings accounts* The amendments made by subsections (a) and (b) shall apply to amounts paid after December 31, 2023.
  - **(2)** *Reimbursements* The amendment made by subsection (c) shall apply to expenses incurred after December 31, 2023.
