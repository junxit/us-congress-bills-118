...
## § 2. Paycheck Protection Loan return guidance
...
- **(b)** *Returns handling process requirements* The process established under subsection (a) shall require—
  ...
  - **(2)** the Administrator to deposit in the general fund of the Treasury the unused amounts of PPP loans returned to the Administration.
...
- **(3)** *PPP loan* The term PPP loan means a loan made under paragraph (36) or (37) of section 7(a) of the Small Business Act (15 U.S.C. 636(a)).
