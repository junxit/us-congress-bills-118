...
- **(a)** *In general* Section 3(e) of the Forest and Rangeland Renewable Resources Research Act of 1978 (16 U.S.C. 1642(e)) is amended—
  ...
  - **(4)** in paragraph (6)—
    ...
    - **(B)** by striking subparagraphs (D) and (E) and inserting the following:
      ...
      > - **(E)** the organization and procedures necessary to evaluate carbon-related data variables, including soil carbon, collected from forest inventory and analysis plots, timber products output studies, and national woodland owner surveys to ensure that carbon accounting information needs can be met; and
  ...
  - **(5)** by adding at the end the following:
    ...
    >     - **(iii)** nonaggregated data from timber product output survey.
