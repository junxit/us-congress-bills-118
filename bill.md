...
- **(a)** *Alternative registration process for schedule I research* Section 303 of the Controlled Substances Act (21 U.S.C. 823) is amended—
  ...
  - **(2)** by adding at the end the following:
    ...
    >     - **(A)** is with respect to a drug that is the subject of an investigational use exemption under section 505(i) of the Federal Food, Drug, and Cosmetic Act (21 U.S.C. 355(i)); or
    >     - **(B)** is—
    ...
    >           - **(bb)** in the case of an application under section 505(i) of the Federal Food, Drug, and Cosmetic Act (21 U.S.C. 355(i)), by supplying the application number and the sponsor of record on the application.
...
- **(f)** *Treatment of certain manufacturing activities as coincident to research* Section 302 of the Controlled Substances Act (21 U.S.C. 822), as amended by subsection (e), is amended by adding at the end the following:
  ...
  >   - **(3)** *Exception regarding marijuana* The authority under paragraph (1) to manufacture substances does not include the authority to grow marijuana.
