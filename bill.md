...
## § 2. Vehicle weight exemption for certain logging vehicles
...
>     - **(C)** meets applicable State legal weight tolerances and vehicle configurations for transporting raw or unfinished forest products within the boundaries of each State in which the vehicle is operating.
