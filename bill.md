...
- **(a)** *In general* Section 403 of the Federal Food, Drug, and Cosmetic Act (21 U.S.C. 343) is amended by adding at the end the following:
  > - **(z)**
  >   - **(1)** If it uses a market name for an egg or egg product described in subparagraph (3) and the food does not meet the criterion for being an egg or egg product, as described in subparagraph (2).
