...
- **(c)** *Grants*
  ...
  - **(4)** *Use of funds* A mining school receiving a grant under paragraph (1) shall use the grant funds—
    ...
    - **(B)** to enhance and support programs related to, as applicable—
      ...
      - **(vi)** technologies to extract, refine, separate, smelt, or produce minerals, including rare earth elements;
...
The Mining and Mineral Resources Research Institute Act of 1984 (30 U.S.C. 1221 et seq.) is repealed.
