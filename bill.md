...
- **(a)** *In general* Section 163 of the Internal Revenue Code of 1986 is amended by redesignating subsection (n) as subsection (o) and by inserting after subsection (m) the following new subsection:
  ...
  >         - **(II)** has as a principal purpose the creation, development, or preservation of affordable housing.
  ...
  >           - **(bb)** stipulate a preemptive option to purchase the affordable rentals or homeownership units so that the affordability of the units is preserved for successive income-eligible households; and
  >         - **(II)** monitors properties to ensure affordability is preserved.
