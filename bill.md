...
## § 2. Repeal of recalibrated single-family pricing framework
...
## § 3. Restrictions on FHFA adjustments to single-family pricing framework
...
## § 4. Prohibition of loan-level price adjustments based on debt-to-income ratio
...
- **(a)** *Study* The Comptroller General of the United States shall conduct a study of the revisions made by the Federal Housing Finance Agency to the standard single-family pricing framework under the recalibrated single-family pricing framework to—
  - **(1)** analyze—
    ...
    - **(C)** the extent to which such revisions comply with the objectives of the Enterprise Regulatory Capital Framework; and
...
- **(5)** *Standard single-family pricing framework* The term “standard single-family pricing framework” means the loan-level pricing adjustment fee structure in effect on April 30, 2023.
