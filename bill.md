...
- **(c)** *Billing procedures*
  - **(1)** *In general* Subchapter I of chapter 17 of such title is amended by adding at the end the following new section:
    ...
    >   - **(2)** If the Secretary does not provide to a veteran notification of a required payment by the date required under paragraph (1), the Secretary may not collect such payment, including through a third-party entity, unless the Secretary provides the veteran the following:
    ...
    >     - **(A)** an error committed by the Department, an employee of the Department, or a non-Department facility was the cause of delaying notification sent to the veteran of the requirement to make the payment; and
...
- **(d)** *Improvement of procedures* Not later than 180 days after the date of the enactment of this Act, the Secretary of Veterans Affairs shall—
  ...
  - **(2)** improve such controls and procedures, including pursuant to the amendments made by this section.
