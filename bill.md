...
## § 3. Disclosure and opt-in requirements for entities that use data to train artificial intelligence systems
...
- **(b)** *Use of covered data To train artificial intelligence systems pursuant To express informed consent* The regulations promulgated by the Commission under subsection (a) shall include the following:
