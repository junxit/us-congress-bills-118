...
- **(a)** *Definitions* In this section:
  ...
  - **(2)** *Covered entity* The term covered entity means an entity that is required to submit Form ADV.
  - **(3)** *Form ADV* The term Form ADV means the form described in section 279.1 of title 17, Code of Federal Regulations, or any successor regulation.
